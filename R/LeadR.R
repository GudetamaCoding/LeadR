...
#'
#' @param filename the filename of the CSV datafile. It must have the following columns: "Depth", the center depth of the sample (in cm), Depth_Span, the width of the sample (in cm), Pb.210, the measured activity (in Bq/g), and "Pb.210_1s" the standard error of that measurement (in Bq/g).
#' @param coredate the data of the top of the core (in years AD).
#' @param unsupp optional, if passed should be a numeric value to use as the baseline Pb-210 (in Bq/g), or "estimate" to automatically estimate it. If you don't pass either you must supply the data as a column in the input data.
#' @param export optional, the name to use for an output datafile.
#'
#' @return an object with the raw data, input, output, and accumulation rate
#'
#' @examples
